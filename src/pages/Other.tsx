  ...
  return (<>
   <Header marginFromTop={'top-1/3'}>
    ...
    <div className='grid grid-cols-1 w-1/3 text-5xl text-purple-800 text-center font-bold justify-center mt-5'>
          ...
          <Link to="/Coming_soon" className='bg-blue-100 rounded-2xl border-4 hover:shadow-2xl border-red-400 m-2 p-5 hover:bg-blue-200 hover:animate-pulse'>IPFS 💾</Link>

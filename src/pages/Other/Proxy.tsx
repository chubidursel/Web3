...
export function Proxy() {
  ...
  <main>
      ...
      <Header marginFromTop={'1/3'}>
       ...
       <Draggable>
        <div className="bg-orange-300 w-max p-5 flex flex-col rounded-2xl ml-12 hover:cursor-grab active:cursor-grabbing">
        ...
        <Draggable>
        <div className='bg-purple-200 h-max w-max p-4 text-center rounded-xl ml-12 mt-3 hover:cursor-grab active:cursor-grabbing'>

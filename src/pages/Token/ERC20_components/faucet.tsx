...
// >>>>>>>> FUNC 1
  ...
  return (
    <>
        ...
        <h1 className='text-center text-gray-400 hover:underline hover:cursor-pointer'><a href="https://goerli.etherscan.io/address/0x581f9c7a2FD6b53041332Bcb7B01d14efB40741F" ></a>Etherscan</h1>
        </div>

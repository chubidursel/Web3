      ...
      <Header marginFromTop={2}>
        ...
        <div className="flex justify-end gap-2 mr-3">
         ...
         <div className=''>
          ...
          <div className=''>
          <a href='https://ipfs.io/ipfs/QmRB4k8jQNeTRUHQZEvStPzSGBwAJWhqvfYUVHCq9GsKVR' target="_blank" >
            <motion.img
              src={ipfs}
              className='h-[85px]'
              whileHover={{ scale: 1.2 }}
        ...
        <Section>
          <div className="flex justify-center -m-5 text-3xl">
            ...
            >
              ...
              <div className=' bg-blue-100 rounded-2xl p-5 flex justify-center flex-col text-center'>

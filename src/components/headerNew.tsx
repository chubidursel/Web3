...
const defiMenu = [{nam: "Exchange", path:"../Defi/exchange"}, {nam: 'Vault', path:'../Defi/vault'}, {nam: "Swap", path:"../Coming_soon"}, {nam: "ChainLink", path:"../ChainLink"}, {nam: "DAO", path:"../DAO"}, {nam: "Auction", path:"..//Defi/Market/Auction"}]

        ...
        <ul className="mt-6 space-y-2 tracking-wide">
          ...
          <li className="min-w-max">
            <a href="#" className="bg group flex items-center space-x-4 rounded-full px-4 py-3 text-gray-600">
              ...
              <span className="group-hover:text-gray-700">I HAVE CHANGE THIS</span>
            </a>
          </li>
          <li className="min-w-max">
            <a href="#" className="group flex items-center space-x-4 rounded-md px-4 py-3 text-gray-600">
              ...
              <span className="group-hover:text-gray-700">WHATS WRONG</span>
            </a>
          </li>
          <li className="min-w-max">
            <a href="#" className="group flex items-center space-x-4 rounded-md px-4 py-3 text-gray-600">
              ...
              <span className="group-hover:text-gray-700">sdcsdcsdc</span>
            </a>
          </li>
          <li className="min-w-max">
            <a href="#" className="group flex items-center space-x-4 rounded-md px-4 py-3 text-gray-600">
